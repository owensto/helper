...
# Outer hull: long low fairing; X is fore/aft
h=add_uv('OuterHull_Main',(0,2.1,0),(41.45,6.85,6.05),WHITE,96);move(h,'OuterHull')
# flatten lower/upper visually with fairing bands
...
# Superstructure levels, progressively shorter/lower
...
# pressure hull architecture: central cylinder plus spherical ends
...
# smaller protected utility cylinders
for z in (-4.7,4.7):
 u=cyl(f'UtilityPressure_{z}',(-3,.2,z),1.5,32,PRESS,(0,math.pi/2,0),48);move(u,'PressureHull')

# ballast tanks distributed outside pressure hull
...
# energy modules low and central
...
# command + habitation visualization blocks
...
# conceptual transformation animation: frame 1 surface, 90 sealed/retracted, 180 submerged visual state
...
# entire vessel moves down in dive phase via parent empty
