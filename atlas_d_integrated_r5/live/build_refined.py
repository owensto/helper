...
def cap(name,p,y,ma,parent,up=True,hole=False,rise=0):
...
ring('Mast_well_coaming',[2.55,12.005,0],.615,.035,black,well)
vv=[];ff=[]
for yy in [9.05,12.0]:
...
tube('Mast_lower_stage',[[0,-.65,0],[0,.35,0]],.26,accent,mast,32)
tube('Mast_upper_stage',[[0,-.3,0],[0,1.7,0]],.19,black,mast,32)
